...
SCHEMA_PATH = Path('/Users/higa4/dev/schedule-app/fastapi/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/higa4/.cache/prisma-python/binaries/5.11.0/efd2449663b3d73d637ea1fd226bafbcf45b3102/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    schedules: 'actions.SchedulesActions[models.Schedules]'
    participants: 'actions.ParticipantsActions[models.Participants]'
    ...
    def __init__(
        ...
        *,
        ...
        self.schedules = actions.SchedulesActions[models.Schedules](self, models.Schedules)
        self.participants = actions.ParticipantsActions[models.Participants](self, models.Participants)
...
class Batch:
    ...
    schedules: 'SchedulesBatchActions'
    participants: 'ParticipantsBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.schedules = SchedulesBatchActions(self)
        self.participants = ParticipantsBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ParticipantsBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
