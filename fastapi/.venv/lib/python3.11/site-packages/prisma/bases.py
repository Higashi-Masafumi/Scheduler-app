...
class BaseSchedules(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Schedules']] = 'Schedules'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SchedulesActions[_PrismaModelT]':
        from .client import get_client

        return actions.SchedulesActions[_PrismaModelT](client or get_client(), cls)


class BaseParticipants(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Participants']] = 'Participants'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ParticipantsActions[_PrismaModelT]':
        from .client import get_client

        return actions.ParticipantsActions[_PrismaModelT](client or get_client(), cls)
